...
eos
  ...
  # Gem dependencies
  s.add_runtime_dependency "logstash-core"#, "5.0.0.alpha6.snapshot5" # this make come from the ENV in the real build job?
  s.add_runtime_dependency "logstash-core-plugin-api"
  s.add_runtime_dependency "logstash-codec-plain"
  s.add_runtime_dependency "manticore"
  s.add_runtime_dependency "launchy" # as a runtime dependency on `addressable`
